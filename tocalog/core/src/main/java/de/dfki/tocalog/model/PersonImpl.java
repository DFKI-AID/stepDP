...
public class PersonImpl implements Person {
    ...
    private java.util.Optional<java.util.List<java.lang.String>> things; 
    private java.util.Optional<java.lang.String> friend; 
    private java.util.Optional<java.util.Map<java.lang.String,java.lang.Double>> meta; 
    ...
    private java.util.Optional<byte[]> bin; 
    ...
    public PersonImpl() {
        ...
        this.bin = java.util.Optional.empty();
    ...
    public Person setName(java.lang.String value) {
        this.name = java.util.Optional.ofNullable(value);
        return this;
    }
    
    public java.util.Optional<java.util.List<java.lang.String>> getThings() {
        return this.things;
    }
    public Person setThings(java.util.List<java.lang.String> value) {
        this.things = java.util.Optional.ofNullable(value);
        return this;
    }
    
    public java.util.Optional<java.lang.String> getFriend() {
        return this.friend;
    }
    public Person setFriend(java.lang.String value) {
        this.friend = java.util.Optional.ofNullable(value);
        return this;
    }
    
    public java.util.Optional<java.util.Map<java.lang.String,java.lang.Double>> getMeta() {
        return this.meta;
    }
    public Person setMeta(java.util.Map<java.lang.String,java.lang.Double> value) {
    ...
    public Person setWuhu(Person value) {
    ...
    public Person setId(java.lang.String value) {
        this.id = java.util.Optional.ofNullable(value);
        return this;
    }
    
    public java.util.Optional<byte[]> getBin() {
        return this.bin;
    }
    public Person setBin(byte[] value) {
        this.bin = java.util.Optional.ofNullable(value);
        return this;
    }
    ...
    public void deserialize(de.dfki.tractat.idl.Deserializer deserializer) throws java.io.IOException {
        ...
        while(true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    {
                        java.util.ArrayList<java.lang.String> tmp_things;int n = deserializer.beginReadList();tmp_things = new java.util.ArrayList<>();for(int i=0; i<n; i++) {java.lang.String tmp;tmp = deserializer.readString();tmp_things.add(tmp);}deserializer.endReadList();this.things = java.util.Optional.of(tmp_things);
                    }
                    break;
                
                case 3:
                    {
                        java.lang.String tmp_friend;tmp_friend = deserializer.readString();this.friend = java.util.Optional.of(tmp_friend);
                    }
                    break;
                
                case 4:
                    {
                        java.util.HashMap<java.lang.String,java.lang.Double> tmp_meta;int n = deserializer.beginReadMap();tmp_meta = new java.util.HashMap<>();for(int i=0; i<n; i++) {java.lang.String tmpKey;tmpKey = deserializer.readString();java.lang.Double tmpValue;tmpValue = deserializer.readDouble();tmp_meta.put(tmpKey, tmpValue);}deserializer.endReadMap();this.meta = java.util.Optional.of(tmp_meta);
                    }
                    break;
                
                case 5:
                    {
                        Person tmp_wuhu;tmp_wuhu = Person.factory.create(); tmp_wuhu.deserialize(deserializer);this.wuhu = java.util.Optional.of(tmp_wuhu);
                    }
                    break;
                ...
                case 6:
                    {
                        ...
                        Person tmp;tmp = Person.factory.create(); tmp.deserialize(deserializer);tmp_foo.add(tmp);}deserializer.endReadList();this.foo = java.util.Optional.of(tmp_foo);
                    }
                    break;
                ...
                case 8:
                    {
                        byte[] tmp_bin;tmp_bin = deserializer.readBinary();this.bin = java.util.Optional.of(tmp_bin);
                    }
                    break;
    ...
    public void serialize(de.dfki.tractat.idl.Serializer serializer) throws java.io.IOException {
        ...
        if(this.things.isPresent()) {
            ...
            serializer.beginWriteList(things.get().size());for(java.lang.String tmp : things.get()) { serializer.writeString(tmp); }serializer.endWriteList();;
        ...
        if(this.meta.isPresent()) {
            ...
            serializer.beginWriteMap(meta.get().size());for(java.util.Map.Entry<java.lang.String,java.lang.Double> tmp : meta.get().entrySet()) { serializer.writeString(tmp.getKey()); serializer.writeDouble(tmp.getValue()); }serializer.endWriteMap();;
        ...
        if(this.foo.isPresent()) {
            ...
            serializer.beginWriteList(foo.get().size());for(Person tmp : foo.get()) { tmp.serialize(serializer); }serializer.endWriteList();;
        ...
        if(this.bin.isPresent()) {
            serializer.beginWriteField(8, "bin");
            serializer.writeBinary(bin.get());;
            serializer.endWriteField(8, "bin");
        }
    ...
    public String toString() {
        ...
        sb.append("Person{");
            ...
            bin.ifPresent(x -> sb.append(" bin=" +x.toString()));
    ...
    @Override
    public de.dfki.tractat.idl.Base copy(de.dfki.tractat.idl.Serializer serializer, de.dfki.tractat.idl.Deserializer deserializer) throws java.io.IOException {
