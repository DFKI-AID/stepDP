...
public class PropStringArray implements IProperty{
    ...
    public PropStringArray(String name, KnowledgeBase parent) throws Exception
    {
        if(name == null)
    ...
    public boolean canCompare(IProperty otherProp) {
        if(otherProp.getClass() == PropStringArray.class)
            return true;
    ...
    public boolean equals(Object o) {
        ...
        PropStringArray that = (PropStringArray) o;
