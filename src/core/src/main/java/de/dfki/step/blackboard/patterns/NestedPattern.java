 ...
 * level object.
 * It is highly recommended to use the {@link PatternBuilder} to define such
 * complex patterns.
 */
public class NestedPattern extends Pattern {
	...
	/**
	 * It is strongly recommended to use {@PatternBuilder} instead of this constructor since
