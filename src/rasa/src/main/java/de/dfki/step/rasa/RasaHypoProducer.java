 ...
 * Values for slots will be stored in the attribute {@link de.dfki.step.kb.Ontology#name}
 * Confidence for slots will be stored in the attribute {@link de.dfki.step.kb.Ontology#confidence}
 *
